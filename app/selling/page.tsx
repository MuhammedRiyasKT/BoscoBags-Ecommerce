...
export default function TrendingPage() {
  ...
  // Sidebar, dropdown controls and state variables
    ...
    <div className="trending-page-wrapper">
      ...
      <section className="trending-hero">
        ...
        <div className="trending-hero-content">
          <h1 className="trending-hero-title">Best Seller</h1>
        ...
        <div className="trending-container">
          ...
          <div className="trending-header-row">
            <h2 className="trending-title">
              <span className="trending-title-highlight">21 Best Seller</span> Collection
            </h2>
