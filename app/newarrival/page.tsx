...
export default function TrendingPage() {
  ...
  // State controls for filtering and sorting menus
  ...
  const FILTERS = ["All", "Backpacks", "Duffel", "Messenger", "Sling", "Laptop"];
  ...
  return (
    <>
      {/* Backdrop for closing sort dropdowns when clicking outside */}
      {isSortOpen && (
        <div 
      ...
      <section className="trending-hero">
        ...
        <div className="trending-hero-content">
          <h1 className="trending-hero-title">New Arrival</h1>
          <p className="trending-hero-subtitle">Explore Our Latest Bags, Made to Highlight Your Unique Profile.</p>
        </div>
      </section>
      ...
      <section className="trending-section">
        <div className="trending-container">
          ...
          {/* Section Header with Title and Filter Dropdowns */}
          <div className="trending-header-row">
            <h2 className="trending-title">
              <span className="trending-title-highlight">5 Our Latest</span> Collection
            </h2>
